...
export function ProviderCard({
  ...
  return (
    ...
    <div className="rounded-3xl border border-hairline bg-surface/95 p-5 shadow-[0_12px_32px_rgba(47,90,134,0.08)] transition-shadow hover:shadow-[0_16px_40px_rgba(47,90,134,0.12)]">
