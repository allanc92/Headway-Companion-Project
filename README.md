...
- **The Mirror** — after enough signal, a held pause synthesizes the transcript into a
  reflection + priority cards that crystallize in.
- **Co-authoring + Honest Map** — drag/edit/discard priorities, nudge the working-style
...
| The Mirror / synthesis | `POST /api/synthesize` | `generateObject` + Zod (reflection + cards) |
...
app/
  ...
  api/{chat,safety,synthesize,match}/route.ts
components/
  home/                 Wordmark, header, find-care form, hero art
  intake/               Conversation, Mirror, priority cards, spectrums, results, artifact
  ui/                   Icons
lib/
